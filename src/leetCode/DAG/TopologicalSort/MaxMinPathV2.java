...
public class MaxMinPathV2 {
    ...
    // starting index of each point's edge info in edgesBySrc
    private int[] offsets;
    // topological sort queue replacing ArrayDeque
    private int[] queue;

    private int tail;
    // minium sum starting from 0
    ...
    public int findMaxPathScore(int[][] edges, boolean[] online, long k) {
        n = online.length;
        // Topological sorting indegree array
